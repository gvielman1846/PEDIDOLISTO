      ...
      <main className="help-content">
        <section id="responsable" className="help-section">
          ...
          <p>
            ...
            <a href="mailto:giovanni.vielman@gmail.com">giovanni.vielman@gmail.com</a>.
          </p>
        </section>
        ...
        <section id="contacto" className="help-section">
          ...
          <p>
            Dudas sobre este aviso: <a href="mailto:giovanni.vielman@gmail.com">giovanni.vielman@gmail.com</a>.
