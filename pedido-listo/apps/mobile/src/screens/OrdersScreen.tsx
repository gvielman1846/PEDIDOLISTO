...
const styles = StyleSheet.create({
  ...
  cutTitle: { fontSize: 18, fontWeight: '900', color: colors.text },
  ...
  cutTotalValue: { fontSize: 20, fontWeight: '900', color: colors.accentDark },
  card: {
    backgroundColor: colors.surface,
    borderRadius: 18,
    padding: 17,
  ...
  customer: { fontSize: 18, fontWeight: '800', color: colors.text, marginTop: 8 },
  customerCompact: { flex: 1, fontSize: 18, fontWeight: '800', color: colors.text, marginRight: 8 },
  ...
  total: { fontSize: 17, fontWeight: '900', color: colors.accentDark },
